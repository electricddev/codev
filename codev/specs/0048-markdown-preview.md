...
```
┌─────────────────────────────────────────────┐
│ [filename.md]        [👁 Preview] [💾 Save] │  <- Toggle + Save buttons
├─────────────────────────────────────────────┤
│                                             │
...
- Edit mode: Shows "👁 Preview" button (click to enter preview)
- Preview mode: Shows "✏️ Edit" button (click to return to edit), Save button grayed out
